...
-- 1. Crear un nuevo dataset personal (reemplazar marcos_demo_dia4 con tu nombre)
...
CREATE OR REPLACE MODEL `marcos_demo_dia4.ga_propensidad_compra_baseline_model` OPTIONS(
...
FROM
  ...
  ML.PREDICT(
    MODEL `marcos_demo_dia4.ga_propensidad_compra_baseline_model`,
